                    ...
                    <div class="table-responsive">
                        <table class="table" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td><a href="?page=Edit-produk&ProdukID=<?= $data['ProdukID']; ?>" class="badge badge-primary p-1" title="Edit"><i class="">Edit</i></a> |
                                    <a href="?page=hapus-produk&ProdukID=<?= $data['ProdukID']; ?>" class="badge badge-danger p-2 delete-data" title='Delete'><i class="">Hapus</i></a></td>
